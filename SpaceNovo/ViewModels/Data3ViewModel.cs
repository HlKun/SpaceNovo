...
{
    public class Data3ViewModel : IDataViewModel
    {
        private Data3ViewModel(Data3View _view)
        {
            view = _view;
        ...
        private readonly Data3View view;

        private static Data3ViewModel _instance = null;
            ...
            get
            {
                if (_instance == null)
                {
                    lock (SynObject)
                    {
                        if (_instance == null)
                        {
                            _instance = new Data3ViewModel(new Data3View());
                        }
                    }
                }
